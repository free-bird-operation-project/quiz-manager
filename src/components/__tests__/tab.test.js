...
describe('Tab', () => {
	...
	describe('create()', () => {
		it('should create tab with valid configuration', () => {
			...
			const tab = new Tab({ buttonInstances: buttons })
			...
			expect(document.body.querySelector('#tab').querySelector('#button-tab-0')).toBeTruthy()
			expect(
				document.body.querySelector('#tab').querySelector('#button-tab-0').querySelector('i')
					.dataset.lucide
			).toBe('cookie')
			expect(document.body.querySelector('#tab').querySelector('#button-tab-1')).toBeTruthy()
			expect(
				document.body.querySelector('#tab').querySelector('#button-tab-1').querySelector('i')
					.dataset.lucide
			).toBe('heart')
		})
		...
		it('should buttons function well with valid configuration', () => {
			...
			const first = document.body.querySelector('#tab').querySelector('#button-tab-0')
			const second = document.body.querySelector('#tab').querySelector('#button-tab-1')
