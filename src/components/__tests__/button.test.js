...
describe('Button', () => {
	...
	describe('remove()', () => {
		it('should remove a button with a valid configuration', () => {
			...
			// After removing the button, we shouldn't be able to click it again.
			// However, since the button is already removed, clicking it won't do anything anyway.
			// Instead, verify that the button is indeed removed.
